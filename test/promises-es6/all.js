...
// var Promise = require('../../lib/begin.js').Promise;
...
describe("25.4.4.1 Promise.all with 1-element array", function () {
    ...
    it("should resolve immediately test", function (done) {
        var obj = {};
    ...
    it.skip("should reject immediately test2", function (done) {
        var obj = {};
...
describe("25.4.4.1 with 2-element array", function () {
    ...
    it.skip("should reject immediately when the first member of a two-promise array rejects", function (done) {
        var rejectP1,
    ...
    it.skip("should reject immediately when the second member of a two-promise array rejects", function (done) {
        var rejectP2,
